...
# MAGIC %md ## Data Load
# MAGIC
# MAGIC DataLake上のデータをロードして、データプロファイルをチェックしてみましょう<br>
# MAGIC 下記セルを実行すると、[Githubレポジトリ](https://github.com/komae5519pv/komae_dbdemos/tree/main/e2e_ML_20250629)からVolumeにcsvがロードされます
